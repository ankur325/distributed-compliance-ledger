...
const (
	...
	QueryAllModelVersion = "allModelVersions"
)
...
func NewQuerier(keeper Keeper) sdk.Querier {
	return func(ctx sdk.Context, path []string, req abci.RequestQuery) (res []byte, err sdk.Error) {
		...
		case QueryModelVersion:
			return queryModelVersion(ctx, path[2:], req, keeper)
		case QueryAllModelVersion:
			return queryModelVersions(ctx, path[2:], req, keeper)
		default:
