...
- Update an existing model info. Only the owner can edit a Model Info.
  ...
  Example: `dclcli tx model update-model --vid=1 --pid=1 --cdVersionNumber="32" --description="New Description" --from=jack `
